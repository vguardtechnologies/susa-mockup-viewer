...
export default function ComparisonView() {
  ...
  const [singleVersion, setSingleVersion] = useState('authentic');
  ...
  return (
    <div className="w-full h-screen bg-neutral-100 overflow-hidden">
      {/* Control Bar */}
      <div className="bg-gradient-to-r from-neutral-900 via-black to-neutral-900 text-white px-6 py-2 shadow-2xl">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-lg font-bold">SUSA Design Comparison</h1>
            ...
            {versions.map(version => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[9px] opacity-80 font-normal">{version.desc}</div>
                </button>
              );
            })}
          </div>
          ...
          {viewMode !== 'all-five' && viewMode !== 'single' && (
            <div className="mt-2 text-xs text-white/60">
